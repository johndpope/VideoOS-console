...
export const SET_FORM_DATA = "OS/SET_FORM_DATA_T";

export const SET_FILE_IPT_STATE = "OS/SET_FILE_IPT_STATE_T";

export const SET_CURRENT_PAGE = "OS/SET_CURRENT_PAGE_T";
