...
export const QUERY_ALL_ACCOUNTTYPES_REQUEST =
  "OS/QUERY_ALL_ACCOUNTTYPES_REQUEST";
export const QUERY_ALL_ACCOUNTTYPES_SUCCESS =
  "OS/QUERY_ALL_ACCOUNTTYPES_SUCCESS";
export const QUERY_ALL_ACCOUNTTYPES_FAILURE =
  "OS/QUERY_ALL_ACCOUNTTYPES_FAILURE";

export const SET_CURRENT_PAGE = "OS/SET_CURRENT_PAGE_A";

export const SET_FORM_DATA = "AA/SET_FORM/DATA";
