...
export default class MaterialTable extends Component {
  ...
  renderOperator = (value, index, record) => {
    ...
    return (
      <div>
        <Button onClick={() => {addMaterialToggle({interactionTypeId: record.interactionId, interactionTypeName: record.interactionName, creativeId: record.creativeId, opType: 'read'})}}>查看</Button>
        {
          shouldShow ? (
            <Fragment>
              <Button 
                onClick={() => {addMaterialToggle({interactionTypeId: record.interactionId, interactionTypeName: record.interactionName, creativeId: record.creativeId, opType: 'update'})}}
              >
                修改
              </Button>
    ...
    return (
      <div className="animated fadeIn">
        ...
        >
          ...
          <Table.Column title="素材类型" dataIndex="interactionTypeName" width={120} />
