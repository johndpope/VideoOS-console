...
export const GET_IATYPE_BYID_REQUEST = "OS/GET_IATYPE_BYID_REQUEST_M";
export const GET_IATYPE_BYID_FAILURE = "OS/GET_IATYPE_BYID_FAILURE_M";
export const GET_IATYPE_BYID_SUCCESS = "OS/GET_IATYPE_BYID_SUCCESS_M";
...
export const SAVE_FORM_DATA = "OS/SAVE_FORM_DATA_M";

export const GET_MATERIAL_INFO_REQUEST = "OS/GET_MATERIAL_INFO_REQUEST";
export const GET_MATERIAL_INFO_SUCCESS = "OS/GET_MATERIAL_INFO_SUCCESS";
export const GET_MATERIAL_INFO_FAILURE = "OS/GET_MATERIAL_INFO_FAILURE";

export const SET_CURRENT_PAGE = "OS/SET_CURRENT_PAGE";

export const SET_FILE_DATA = "OS/SET_FILE_DATA";

export const SET_SWITCHER = "OS/SET_SWITCHER";

export const SET_MATERIAL_SCHEMA = "OS/SET_MATERIAL_SCHEMA";
