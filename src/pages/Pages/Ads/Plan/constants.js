...
export const SHOW_LAUNCH_PLAN = "OS/SHOW_LAUNCH_PLAN";
export const HIDE_LAUNCH_PLAN = "OS/HIDE_LAUNCH_PLAN";
...
export const LAUNCH_PLAN_REQUEST = "OS/LAUNCH_PLAN_REQUEST";
export const LAUNCH_PLAN_SUCCESS = "OS/LAUNCH_PLAN_SUCCESS";
export const LAUNCH_PLAN_FAILURE = "OS/LAUNCH_PLAN_FAILURE";
...
export const SET_RELAUNCH = "OS/SET_RELAUNCH";

export const SET_PLAN_RESULT = "OS/SET_PLAN_RESULT";
